...
var books = ["Frankenstein", "Furiously Happy", "The Jungle", "Code", "Wild At Home"];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

books[2];
books[3]; //3rd element or index 3?

// Create a new variable "belowTwoHundred" and assign it to an Array of 12
// different numbers below two hundred.

var belowTwoHundred = [1, 4, 6, 44, 20, 101, 150, 30, 72, 180, 53, 189];

// Write the code to access the 5th element of the array, using bracket notation.

belowTwoHundred[4];
belowTwoHundred[5]; //see note above -- fifth or at fifth index?
